...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initClearDbButtonListener()
        initSwipeToDelete()

        // each click on the button will pre-pend n items to the database
        syncJob = viewModel.initFillDb({ waitForClick(batchPrependButton) })
    }
    ...
    private fun initClearDbButtonListener() {
...
// helper function that just suspends a coroutine when clicking on a view
suspend fun waitForClick(view: View) =  suspendCoroutine<Unit> { continuation ->
